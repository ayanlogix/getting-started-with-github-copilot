...
// trigger step 3
        ...
        const participantInfo = details.participants.length > 0
        ...
        activityCard.innerHTML = `
          ...
          <details class="participant-details">
            <summary><strong>Participants (${details.participants.length}/${details.max_participants})</strong></summary>
            <ul class="participant-list">${participantInfo}</ul>
          </details>
        `;
